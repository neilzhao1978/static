...
services.constant("Config", {
    ...
    messages: { //错误提示
        ...
        emailConfirmSuccess: "账号激活成功。",
        emailConfirmError: "账号激活失败。",
    ...
    ajaxUrls: {
        signIn: "api/security/login",
        signUp: "api/security/register",
        editInfo: "api/users/:userId/setting",
        changePwd: "api/security/change_password",
        forgetPwd: "api/security/reset",
        ...
        setUserActive: "api/security/confirm",
...
services.service("CFunctions", ["$rootScope", "$location", "$http", "$timeout", "toaster", "Config", "LocationChanger", "Storage",
    function ($rootScope, $location, $http, $timeout, toaster, Config, LocationChanger, Storage) {
        ...
        this.checkMobile = function () {
            ...
            var agentLength = userAgentList.length,
                appLength = appNameList.length;
            var i = 0,
                j = 0;
            ...
            var uploader = Qiniu.uploader({
                ...
                init: {
                    ...
                    'BeforeUpload': function (up, file) {
                        ...
                        $http.put(Config.ajaxUrls.addUploadedKey, {
                            key: src
                        }, {
    ...
    function ($rootScope, $resource, Storage, CFunctions, Config) {
        return {
            getProjects: function () {
                var me = this.resource.query({
                    page: Storage.lastLoadedId + 1
                }, function (data) {
            ...
            getSearchResult: function (content) {
                var me = this.resource.getSearchResult({
                    offset: Storage.lastLoadedId,
                    q: content
                }, function (data) {
            ...
            resource: $resource(Config.ajaxUrls.getAllProjects, {}, {
                ...
                getManageProjects: {
                    method: "get",
                    url: Config.ajaxUrls.getManageProjects,
                    params: {
                        "count": 10
                    }
                },
                get: {
                    method: "get",
                    url: Config.ajaxUrls.getProjectDetail,
                    params: {
                        projectId: 0
                    }
                },
                delete: {
                    method: "delete",
                    url: Config.ajaxUrls.deleteProject,
                    params: {
                        projectId: 0
                    }
                },
                ...
                save: {
                    method: "post",
                    url: Config.ajaxUrls.projectUpdate,
                    transformResponse: function (data, headersGetter) {
                        return JSON.parse(data);
                    }
                },
                add: {
                    method: "put",
                    url: Config.ajaxUrls.projectCreate,
                    params: {},
                    transformResponse: function (data, headersGetter) {
                        return JSON.parse(data);
                    }
                ...
                addToBox: {
                    method: "put",
                    url: Config.ajaxUrls.addProjectToBox,
                    params: {
                        boxId: 0
                    },
                    transformResponse: function (data, headersGetter) {
                ...
                toggleShowProject: {
                    method: "post",
                    url: Config.ajaxUrls.toggleShowProject,
                    params: {
                        projectId: 0
                    }
                },
                praiseProject: {
                    method: "post",
                    url: Config.ajaxUrls.praiseProject,
                    params: {
                        projectId: 0
                    }
                },
                ...
                getProjectAttachments: {
                    method: "get",
                    url: Config.ajaxUrls.getProjectAttachments,
                    params: {
                        id: 0
                    }
                },
                getSearchResult: {
                    method: "get",
                    url: Config.ajaxUrls.getSearchProjects,
                    params: {
                        offset: 0,
                        q: "",
                        "count": Config.perLoadCount
                ...
                getSimilarProjects: {
                    method: "get",
                    url: Config.ajaxUrls.getSimilarProjects,
                    params: {
                        id: 0
                    }
                }
...
services.factory("User", ["$rootScope", "$resource", "CFunctions", "Storage", "Config", function ($rootScope, $resource, CFunctions, Storage, Config) {
    return {
        getUserProjects: function (userId) {
            var me = this.resource.getUserProjects({
                userId: userId,
                last_id: Storage.lastLoadedId
            }, function (data) {
        ...
        resource: $resource(Config.ajaxUrls.getManageUsers, {}, {
            ...
            getUserProjects: {
                method: "get",
                url: Config.ajaxUrls.getUserProjects,
                params: {
                    userId: 0,
                    last_id: 0,
                    "count": Config.perLoadCount
            ...
            setUserActive: {
                method: "post",
                url: Config.ajaxUrls.setUserActive
            },
            setUserRole: {
                method: "post",
                url: Config.ajaxUrls.setUserRole,
                params: {
                    userId: 0
                }
            },
            getCurrentUser: {
                method: "get",
                url: Config.ajaxUrls.getCurrentUser
            },
            forgetPwd: {
                method: "post",
    ...
    function ($rootScope, $resource, CFunctions, Config, Storage) {
        return {
            ...
            getBoxProjects: function (boxId) {
                var me = this.resource.getBoxProjects({
                    boxId: boxId,
                    last_id: Storage.lastLoadedId
                }, function (data) {
            ...
            resource: $resource(Config.ajaxUrls.getAllBoxes, {}, {
                ...
                get: {
                    method: "get",
                    url: Config.ajaxUrls.getBoxDetail,
                    params: {
                        boxId: 0
                    }
                },
                ...
                setBoxStatus: {
                    method: "post",
                    url: Config.ajaxUrls.setBoxStatus,
                    params: {
                        boxId: 0
                    }
                },
                ...
                getBoxProjects: {
                    method: "get",
                    url: Config.ajaxUrls.getBoxProjects,
                    params: {
                        boxId: 0,
                        last_id: 0,
                        count: Config.perLoadCount
...
services.factory("Comment", ["$rootScope", "$resource", "Config", function ($rootScope, $resource, Config) {
    return $resource(Config.ajaxUrls.getManageComments, {}, {
        ...
        getCommentsByProject: {
            method: "get",
            url: Config.ajaxUrls.getProjectComments,
            params: {
                projectId: 0
            }
        },
        add: {
            method: "put",
            url: Config.ajaxUrls.addComment,
            params: {
                projectId: 0
            }
        }
